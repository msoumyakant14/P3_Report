...
\begin{document}
	...
	In this project, we investigate techniques to set-up a distributed and containerized Open edX instance using Kubernetes as the Orchestrator. Furthermore, we conduct tests on Open edX Native and Open edX Devstack to compare them by measuring several performance metrics.
