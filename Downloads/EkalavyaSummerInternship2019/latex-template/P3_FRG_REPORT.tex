...
At first, we set up a Kubernetes cluster as mentioned \hyperref[sec:kubeclustset]{above} with one master and three nodes.
\begin{figure}[h!]
	\begin{center}
...
\section{Tutor}
Tutor is an open source tool to deploy an Open edX instance for production. Tutor supports both single and multinode cluster deployment. Tutor also supports Kubernetes cluster deployment. To read more about tutor visit \url{https://docs.tutor.overhang.io/}\cite{Tutor}. 
\pagebreak
